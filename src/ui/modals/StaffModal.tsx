                    ...
                    <div className="flex items-center gap-2 w-full md:w-auto">
                      ...
                      {emp.level < 3 && (
                        <button
                          ...
                          className="bg-slate-800 hover:bg-slate-700 text-indigo-300 text-xs font-bold px-3 py-2 rounded-xl border border-indigo-500/30 flex items-center gap-1"
                        >
          ...
          <div className="p-6 flex flex-col gap-4 overflow-y-auto flex-1">
            {!hasManager ? (
              ...
              <div className="bg-slate-950/60 border border-slate-800 rounded-2xl p-5 flex flex-col gap-4">
                ...
                <button
                  onClick={hireManager}
                  className="w-full py-3.5 rounded-2xl font-black text-sm uppercase tracking-wider bg-indigo-600 hover:bg-indigo-500 text-white shadow-xl shadow-indigo-600/30 transition-all mt-2"
                >
